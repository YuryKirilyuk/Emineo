...
class Skin_Custom_Cards extends Skin_Base {
	...
	public function get_title() {
		return __( 'Custom Cards', 'elementor-pro' );
	}
	...
	protected function render_badge() {
        $image = get_field('main_logo', get_the_ID());
        if($image) {
		?>
		<div class="elementor-post__badge"><img src="<?php echo $image; ?>" /></div>
        <?php
        }
	}
...
add_action( 'elementor/widget/posts/skins_init', function( $widget ) {
    $widget->add_skin( new Skin_Custom_Cards( $widget ) );
 } );